"""
Sprite Viewer Plugin
====================

Plugin implementation for Sprite Viewer.

Created: 2025-11-09
"""

from plugins.base_plugin import VisualizerPlugin, PluginStatus
from typing import Dict, Any, List

class SpriteViewerPlugin(VisualizerPlugin):
	"""Implementation of Sprite Viewer plugin"""
...
def create_plugin(metadata):
	...
	return SpriteViewerPlugin(metadata)
