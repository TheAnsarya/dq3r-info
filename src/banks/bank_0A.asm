...
Bank_0A_Function_0F:
	...
	INX				  ; E8
	PHD				  ; 0B
	JSL $08090A		  ; 22 0A 09 08
	BRK $61			  ; 00 61
	JMP ($0CE8)		  ; 6C E8 0C
	JSL $080909		  ; 22 09 09 08
	BRK $42			  ; 00 42
	ADC $03E8			; 6D E8 03
	TRB $0E			  ; 14 0E
	ORA #$08			 ; 09 08
...
Bank_0A_Function_13:
	...
	BRK $00			  ; 00 00
	BRK $7A			  ; 00 7A
	ADC $000165		  ; 6F 65 01 00
	BRK $00			  ; 00 00
	CMP $00C070,X		; DF 70 C0 00
	BRK $00			  ; 00 00
	BRK $9F			  ; 00 9F
	ADC $D3			  ; 71 D3
	BRK $00			  ; 00 00
