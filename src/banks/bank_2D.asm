...
Bank_2D_Function_00:
    ORA $7B01,X          ; 1D 01 7B
    ORA $EF              ; 03 EF
    ORA $F87E7E          ; 0F 7E 7E F8
    SED                  ; F8
    CPY #$C0             ; C0 C0
    ORA $FFFF0F          ; 0F 0F FF FF
...
Bank_2D_Function_08:
    LDA $D746,Y          ; B9 46 D7
    PLP                  ; 28
    CMP $14EF20,X        ; DF 20 EF 14
    SBC $C07F92          ; EF 92 7F C0
    LDA $F74E,Y          ; B9 4E F7
    CLC                  ; 18
    BRK $00              ; 00 00
    ; Skipped 32 bytes of data
...
Bank_2D_Function_09:
    ...
    BRK $02              ; 00 02
    SBC $00FF00,X        ; FF 00 FF 00
    SBC $03FC00,X        ; FF 00 FC 03
    INC $FF01,X          ; FE 01 FF
    BRK $BF              ; 00 BF
    RTI                  ; 40
    ORA $BCBCE0,X        ; 1F E0 BC BC
    AND $C0F9,Y          ; 39 F9 C0
    ORA $7F01F0,X        ; 1F F0 01 7F
    BRK $88              ; 00 88
    BRK $24              ; 00 24
    STA $40              ; 81 40
    BRA $8974            ; 80 43
    SBC $FF3FC6,X        ; FF C6 3F FF
    BRK $FF              ; 00 FF
    BRK $7F              ; 00 7F
    BRA $894A            ; 80 0F
    BEQ $8984            ; F0 47
    SEC                  ; 38
    ADC $0E              ; 71 0E
    STA $FFC08F          ; 8F 8F C0 FF
    ORA $000180,X        ; 1F 80 01 00
    BRA $8986            ; 80 3C
    RTS                  ; 60
    ORA $078018          ; 0F 18 80 07
    BRK $70              ; 00 70
    SBC $FFC03F,X        ; FF 3F C0 FF
    BRK $FF              ; 00 FF
    BRK $FF              ; 00 FF
    BRK $FF              ; 00 FF
    BRK $FF              ; 00 FF
...
Bank_2D_Function_0A:
    ...
    JMP ($23FC,X)        ; 7C FC 23
    SBC $3F              ; E3 3F
    SBC $C3FF13,X        ; FF 13 FF C3
    SBC $00FF79,X        ; FF 79 FF 00
    SBC $83FF00,X        ; FF 00 FF 83
    ADC $C03FDC,X        ; 7F DC 3F C0
    ORA $EC              ; 11 EC
    BRK $FC              ; 00 FC
    BRK $FE              ; 00 FE
    BRK $FF              ; 00 FF
    ...
    SBC $00DF1D,X        ; FF 1D DF 00
    SBC $38              ; E7 38
    SBC $00FF00,X        ; FF 00 FF 00
    SBC $00FF00,X        ; FF 00 FF 00
    SBC $E27F80,X        ; FF 80 7F E2
    AND $18FF,X          ; 3D FF 18
    CMP $18              ; C7 18
    INC $FFFE,X          ; FE FE FF
    SBC $FFFFFF,X        ; FF FF FF FF
...
Bank_2D_Function_0C:
    ...
    BRK $00              ; 00 00
    BRK $30              ; 00 30
    LDA $FBE7F3          ; AF F3 E7 FB
    SBC $F9              ; F7 F9
    SBC $FE              ; F3 FE
    TYX                  ; BB
    ADC $3B7FBB,X        ; 7F BB 7F 3B
    SBC $7FDF1F,X        ; FF 1F DF 7F
    ORA $7F              ; 01 7F
    ORA $3F              ; 01 3F
    BRK $1E              ; 00 1E
    ORA $1F              ; 01 1F
    ...
    BRK $0F              ; 00 0F
    JSR $F8FF            ; 20 FF F8
    SBC $67FFF6,X        ; FF F6 FF 67
    SBC $7FFF8F,X        ; FF 8F FF 7F
...
Bank_2D_Function_15:
    SBC $0E0EFF,X        ; FF FF 0E 0E
    SBC $FCFCFF,X        ; FF FF FC FC
    SBC $FFFFFF,X        ; FF FF FF FF
    SBC $3F3FFF,X        ; FF FF 3F 3F
    TSB $00              ; 04 00
    BRK $F1              ; 00 F1
    BRK $00              ; 00 00
    SED                  ; F8
    ...
    BRK $FF              ; 00 FF
    CPY #$FF             ; C0 FF
    SBC $003F3F,X        ; FF 3F 3F 00
    BRK $38              ; 00 38
    SEC                  ; 38
    SBC $FFFFFF,X        ; FF FF FF FF
    ; Skipped 32 bytes of data
    SBC $FFFFFF,X        ; FF FF FF FF
    SBC $007F1C,X        ; FF 1C 7F 00
    CLC                  ; 18
    BRK $1C              ; 00 1C
    BRK $70              ; 00 70
    BRK $01              ; 00 01
    ...
    BEQ $957E            ; F0 00
    INC $FF00,X          ; FE 00 FF
    SBC $1FFFFF,X        ; FF FF FF 1F
    ORA $000000,X        ; 1F 00 00 00
    BRK $E0              ; 00 E0
    CPX #$0F             ; E0 0F
    ORA $03FFFF          ; 0F FF FF 03
    BRK $00              ; 00 00
    BRK $00              ; 00 00
    CPX #$00             ; E0 00
    SBC $00FF00,X        ; FF 00 FF 00
...
Bank_2D_Function_19:
    XCE                  ; FB
    SBC $F7F7FB,X        ; FF FB F7 F7
    SBC $EBFFF3,X        ; FF F3 FF EB
    SBC $EF              ; F7 EF
    SBC $EFFFEF,X        ; FF EF FF EF
    SBC $FF00FF,X        ; FF FF 00 FF
    BRK $FF              ; 00 FF
    BRK $FF              ; 00 FF
    BRK $FF              ; 00 FF
...
Bank_2D_Function_1A:
    SBC $FFDFFF          ; EF FF DF FF
    SBC $FFBFFF,X        ; FF FF BF FF
    LDA $FFFFFF,X        ; BF FF FF FF
    SBC $FFFFFF,X        ; FF FF FF FF
    SBC $00FF00,X        ; FF 00 FF 00
    SBC $00FF00,X        ; FF 00 FF 00
    SBC $00FF00,X        ; FF 00 FF 00
    ...
    BRK $08              ; 00 08
    RTI                  ; 40
    LDA $40B840          ; AF 40 B8 40
    LDY #$00             ; A0 00
    BRK $00              ; 00 00
    BRK $3C              ; 00 3C
    BIT $FFFF,X          ; 3C FF FF
    SBC $1000FF,X        ; FF FF 00 10
    BRK $07              ; 00 07
    BRK $1F              ; 00 1F
    BRK $FF              ; 00 FF
    BRK $FF              ; 00 FF
    ...
    BRK $7F              ; 00 7F
    BRK $08              ; 00 08
    ORA $3F3F0F          ; 0F 0F 3F 3F
    ORA $F3              ; 03 F3
    BRK $E0              ; 00 E0
    ORA $87              ; 07 87
    JSR ($FFFC,X)        ; FC FC FF
    SBC $00F700,X        ; FF 00 F7 00
    BEQ $9A96            ; F0 01
    CPY #$00             ; C0 00
    TSB $1F00            ; 0C 00 1F
    BRK $78              ; 00 78
...
Bank_2D_Function_1C:
    ...
    BRK $40              ; 00 40
    SBC $00FF00,X        ; FF 00 FF 00
    SBC $C03F00,X        ; FF 00 3F C0
    ADC $00FF80,X        ; 7F 80 FF 00
    SBC $F802,X          ; FD 02 F8
    ORA $1F              ; 07 1F
    ADC $000F03,X        ; 7F 03 0F 00
    STA $C1              ; 83 C1
    BEQ $9BB7            ; F0 8E
    CPY #$20             ; C0 20
    BRK $01              ; 00 01
    BRK $B3              ; 00 B3
    BRK $E0              ; 00 E0
    ORA $FF03FC,X        ; 1F FC 03 FF
    BRK $FF              ; 00 FF
    BRK $FE              ; 00 FE
    ORA $E8              ; 01 E8
    ORA $00              ; 17 00
    SBC $FFFF00,X        ; FF 00 FF FF
    SBC $C8F5F4,X        ; FF F4 F5 C8
    WAI                  ; CB
    PER $0407            ; 62 07 04
    ASL $7F19,X          ; 1E 19 7F
    ORA $0DB8,Y          ; 19 B8 0D
    ...
    PHD                  ; 0B
    JSR ($F837,X)        ; FC 37 F8
    SBC $C0FFF8,X        ; FF F8 FF C0
    SBC $00FF80,X        ; FF 80 FF 00
    SBC $FF00,X          ; FD 00 FF
    SBC $119F1C,X        ; FF 1C 9F 11
    JSR ($7033,X)        ; FC 33 70
    INC $6CE0            ; EE E0 6C
    BPL $9C9D            ; 10 30
    CPY #$80             ; C0 80
    BRK $00              ; 00 00
    SBC $EF7CE3,X        ; FF E3 7C EF
    BPL $9C76            ; 10 FF
    BRK $FF              ; 00 FF
    BRK $EF              ; 00 EF
    BRK $3F              ; 00 3F
...
Bank_2D_Function_27:
    ...
    BRK $00              ; 00 00
    ORA $00              ; 07 00
    CMP $0F713F,X        ; DF 3F 71 0F
    SBC $F8              ; E5 F8
    CPX #$00             ; E0 00
    CPX #$00             ; E0 00
    SBC $00FF00,X        ; FF 00 FF 00
    SBC $FFFCFF,X        ; FF FF FC FF
    LDA $FFFFBF,X        ; BF BF FF FF
    SBC $1F1FFF,X        ; FF FF 1F 1F
    BRK $00              ; 00 00
    BRK $00              ; 00 00
    ORA $FFC0E0,X        ; 1F E0 C0 FF
    SBC $F768FF,X        ; FF FF 68 F7
    ORA $004100,X        ; 1F 00 41 00
    SBC $00FE00,X        ; FF 00 FE 00
    SBC $FF7FFF,X        ; FF FF 7F FF
    ASL $FF              ; 06 FF
    STA $E0E0FF,X        ; 9F FF E0 E0
    LDX $00BE,Y          ; BE BE 00
    BRK $01              ; 00 01
    ORA $08              ; 01 08
    ORA $3F              ; 07 3F
    SBC $7FFFFF,X        ; FF FF FF 7F
    SBC $FF01A0,X        ; FF A0 01 FF
    BRK $E3              ; 00 E3
    BRK $9C              ; 00 9C
    BRK $FF              ; 00 FF
    SBC $C0FFF8,X        ; FF F8 FF C0
    SBC $5FFF80,X        ; FF 80 FF 5F
    EOR $1C0000,X        ; 5F 00 00 1C
    TRB $7F7F            ; 1C 7F 7F
    TRB $FFE3            ; 1C E3 FF
    SBC $FBFFFF,X        ; FF FF FF FB
    SBC $DFC130,X        ; FF 30 C1 DF
    BRK $FF              ; 00 FF
    BRK $7F              ; 00 7F
    BRK $FF              ; 00 FF
    SBC $00FF00,X        ; FF 00 FF 00
