...
Bank_36_Function_05:
    ...
    CPY #$40             ; C0 40
    BRA $04C0            ; 80 80
    AND $021E00,X        ; 3F 00 1E 02
    ORA $010505          ; 0F 05 05 01
    TRB $7F04            ; 1C 04 7F
    ORA $CF              ; 13 CF
    BMI $05CD            ; 30 7E
    ASL $3F              ; 06 3F
...
Bank_36_Function_12:
    ...
    INX                  ; E8
    JSR $2060            ; 20 60 20
    ADC $083B18,X        ; 7F 18 3B 08
    ORA $80EF00          ; 0F 00 EF 80
    STP                  ; DB
    BRA $1211            ; 80 DC
    BRA $1216            ; 80 DF
    DEY                  ; 88
    EOR $476740,X        ; 5F 40 67 47
    AND $33              ; 37 33
    ORA $401B0F          ; 0F 0F 1B 40
    TSC                  ; 3B
    COP $DF              ; 02 DF
    TSB $1F              ; 04 1F
    TSB $F6              ; 04 F6
...
Bank_36_Function_18:
    ...
    BRA $17FF            ; 80 FA
    CMP $0D              ; C5 0D
    SBC $207D70,X        ; FF 70 7D 20
    BNE $184D            ; D0 40
    LDY #$00             ; A0 00
    RTI                  ; 40
    BRK $00              ; 00 00
    ADC $3FC0FB,X        ; 7F FB C0 3F
    ORA $70F2            ; 0D F2 70
    STA $F000            ; 8D 00 F0
    BRK $E0              ; 00 E0
    BRK $40              ; 00 40
    BRK $00              ; 00 00
    CPX #$1F             ; E0 1F
    CMP $FFE023,X        ; DF 23 E0 FF
    LDY #$60             ; A0 60
    RTS                  ; 60
    STA $096F1F,X        ; 9F 1F 6F 09
    ORA $00              ; 17 00
    BRK $00              ; 00 00
    ORA $E0FC03,X        ; 1F 03 FC E0
    ORA $00DF22,X        ; 1F 22 DF 00
    SBC $01700F,X        ; FF 0F 70 01
    ASL $0000,X          ; 1E 00 00
    BRK $00              ; 00 00
    BRK $80              ; 00 80
    BRK $E0              ; 00 E0
