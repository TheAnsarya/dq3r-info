...
Bank_37_Function_20:
	...
	CPY #$00			 ; C0 00
	BRK $F1			  ; 00 F1
	SBC $F93FC1,X		; FF C1 3F F9
	INC $FE71,X		  ; FE 71 FE
	ORA $FA			  ; 07 FA
	ORA $C0F8F0,X		; 1F F0 F8 C0
	INC $00			  ; E6 00
	AND #$B6			 ; 29 B6
	BVC $A07D			; 50 D9
	ADC $26D9,Y		  ; 79 D9 26
	LSR $29			  ; 46 29
	ORA $091F00,X		; 1F 00 1F 09
	ASL $0F,X			; 16 0F
	ORA $260040,X		; 1F 40 00 26
	BRK $06			  ; 00 06
	BRK $19			  ; 00 19
	BRK $00			  ; 00 00
	BRK $00			  ; 00 00
	ASL $00,X			; 16 00
	ORA $401F00,X		; 1F 00 1F 40
	BNE $A063			; D0 A0
	BCS $A0A5			; B0 E0
	BCS $A107			; B0 40
	JSR $8040			; 20 40 80
...
Bank_37_Function_23:
	...
	STA $7F			  ; 83 7F
	TDC				  ; 7B
	STA $61EC93		  ; 8F 93 EC 61
	ROR $70FC,X		  ; 7E FC 70
	XCE				  ; FB
	STY $97			  ; 84 97
	PLA				  ; 68
	SBC $00FC04,X		; FF 04 FC 00
	PEA $F40C			; F4 0C F4
	ORA $00877E		  ; 0F 7E 87 00
	BRK $00			  ; 00 00
	BRK $00			  ; 00 00
	BRA $A347			; 80 00
	BRK $00			  ; 00 00
