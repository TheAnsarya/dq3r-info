...
Bank_47_Function_01:
	...
	ORA $FC			  ; 03 FC
	CMP $38			  ; C7 38
	AND $E1DFC0,X		; 3F C0 DF E1
	LDA $3E			  ; A7 3E
	CLD				  ; D8
	STA $03FF07,X		; 9F 07 FF 03
	SBC $00FF00,X		; FF 00 FF 00
	SBC $E1FFC0,X		; FF C0 FF E1
	SBC $FF3FFE,X		; FF FE 3F FF
	...
	SBC $9E,X			; F5 9E
	NOP				  ; EA
	AND $F6FF1B,X		; 3F 1B FF F6
	SBC $FDFFFB,X		; FF FB FF FD
	SBC $DFFFFE,X		; FF FE FF DF
	SBC $3FFF9F,X		; FF 9F FF 3F
	SBC $E4FDF7,X		; FF F7 FD E4
	TRB $6C			  ; 14 6C
	STZ $7898			; 9C 98 78
	TYA				  ; 98
	SED				  ; F8
...
Bank_47_Function_12:
	SBC $669F3C,X		; FF 3C 9F 66
	AND $00FFCF,X		; 3F CF FF 00
	ASL $01F1			; 0E F1 01
	INC $FF00,X		  ; FE 00 FF
	BRK $FF			  ; 00 FF
	BRK $FF			  ; 00 FF
	...
	BRA $91DA			; 80 BF
	JMP $F10F			; 4C 0F F1
	ORA $FC03F0		  ; 0F F0 03 FC
	ORA $FC			  ; 03 FC
	ORA $E21FF1		  ; 0F F1 1F E2
	JSR ($FE03,X)		; FC 03 FE
	ORA $F0FF,Y		  ; 19 FF F0
	SBC $F0FFF3,X		; FF F3 FF F0
	SBC $03FCF0,X		; FF F0 FC 03
	ORA $F8			  ; 07 F8
	ASL $18F1			; 0E F1 18
	SBC $F0			  ; E7 F0
	ORA $033FC0		  ; 0F C0 3F 03
	ORA $03			  ; 03 03
	ORA $01			  ; 03 01
	ORA $03			  ; 01 03
	ORA $01			  ; 03 01
	...
	ASL				  ; 0A
	ORA $17			  ; 17 17
	EOR $BFB95F,X		; 5F 5F B9 BF
	ROR $AE71			; 6E 71 AE
	CMP $91			  ; D1 91
	SBC $190019,X		; FF 19 00 19
	BRK $35			  ; 00 35
	PHP				  ; 08
	AND $18			  ; 27 18
	AND $1A2518		  ; 2F 18 25 1A
	BIT $0B,X			; 34 0B
	ROL $E501,X		  ; 3E 01 E5
	INC				  ; 1A
	SBC $BC02,X		  ; FD 02 BC
...
Bank_47_Function_14:
	...
	SBC $FFE4,X		  ; FD E4 FF
	NOP				  ; EA
	SBC $EAFFE4,X		; FF E4 FF EA
	SBC $E2FFE4,X		; FF E4 FF E2
	SBC $B2FFE8,X		; FF E8 FF B2
	SBC $70			  ; F3 70
	SBC $F2			  ; F3 F2
	SBC $F0			  ; F3 F0
	SBC $F2			  ; F3 F2
	...
	SBC $F4			  ; F3 F4
	SBC $E0			  ; F7 E0
	SBC $E4FFE0,X		; FF E0 FF E4
	SBC $E0FFE0,X		; FF E0 FF E0
	SBC $E0FFE0,X		; FF E0 FF E0
	...
	SBC $E0FFE0,X		; FF E0 FF E0
	SBC $E0FFE0,X		; FF E0 FF E0
	SBC $ECFFE0,X		; FF E0 FF EC
	SBC $ECFFFC,X		; FF FC FF EC
	SBC $ECFFFC,X		; FF FC FF EC
	SBC $ECFFDC,X		; FF DC FF EC
...
Bank_47_Function_18:
	ORA $03			  ; 03 03
	ORA $1F1D0F		  ; 0F 0F 1D 1F
	ORA $1D1B1D,X		; 1F 1D 1B 1D
	TCS				  ; 1B
	ORA $1F19,X		  ; 1D 19 1F
	ORA $00001F,X		; 1F 1F 00 00
	RTI				  ; 40
	RTI				  ; 40
	TAY				  ; A8
	TAY				  ; A8
	...
	ORA $1D1B,X		  ; 1D 1B 1D
	ORA $1F1F,Y		  ; 19 1F 1F
	ORA $1B1D1B,X		; 1F 1B 1D 1B
	ORA $1F19,X		  ; 1D 19 1F
	ORA $00001F,X		; 1F 1F 00 00
	BRK $00			  ; 00 00
	ORA $03			  ; 03 03
	ASL $381F,X		  ; 1E 1F 38
	AND $7C3F30,X		; 3F 30 3F 7C
	ADC $3C7F7E,X		; 7F 7E 7F 3C
	BIT $FFF3,X		  ; 3C F3 FF
	ORA $03			  ; 03 03
	INC $F9			  ; E6 F9
	ASL $3F09			; 0E 09 3F
	AND $74FF43,X		; 3F 43 FF 74
	TDC				  ; 7B
	AND $692D			; 2D 2D 69
	ADC #$52			 ; 69 52
	EOR $76			  ; 52 76
...
Bank_47_Function_22:
	...
	SBC $FFE0FF,X		; FF FF E0 FF
	SBC $FF80FF,X		; FF FF 80 FF
	JSR ($FFFF,X)		; FC FF FF
	SBC $00FFFF,X		; FF FF FF 00
	SBC $00FFE0,X		; FF E0 FF 00
	SBC $0FFFF0,X		; FF F0 FF 0F
	BEQ $A263			; F0 00
	SBC $F8FF00,X		; FF 00 FF F8
	SBC $00FF00,X		; FF 00 FF 00
	SBC $00FF00,X		; FF 00 FF 00
	SBC $1F00FF,X		; FF FF 00 1F
	CPX #$7F			 ; E0 7F
	BRA $A277			; 80 00
	SBC $00FF00,X		; FF 00 FF 00
	SBC $00FF00,X		; FF 00 FF 00
