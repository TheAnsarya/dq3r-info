...
Bank_6B_Function_11:
    ...
    ORA $EE              ; 07 EE
    AND $00              ; 37 00
    SBC $0037EE          ; EF EE 37 00
    SBC $003708          ; EF 08 37 00
    ORA #$F8             ; 09 F8
    ROR $E710            ; 6E 10 E7
    SED                  ; F8
    ROR $F810            ; 6E 10 F8
...
Bank_6B_Function_12:
    ...
    SBC $00010A,X        ; FF 0A 01 00
    SBC $00010B,X        ; FF 0B 01 00
    SBC $00010C,X        ; FF 0C 01 00
    SBC $00010D,X        ; FF 0D 01 00
    SBC $00010E,X        ; FF 0E 01 00
