...
; Type: Graphics/DMA
; Purpose: Graphics DMA transfers, PPU control, and sprite management
...
;------------------------------------------------------------------------------
; InitializeDMAChannel
; Address: $E0807E
; Size: 21 bytes
;------------------------------------------------------------------------------
InitializeDMAChannel:
	; Sets up DMA channel for graphics transfer
	; Configures source address, destination, and transfer mode
...
;------------------------------------------------------------------------------
ConfigureDMATransfer:
	; Configures DMA parameters for large graphics transfers
	; Used for loading sprite and tile data to VRAM
	JSR $7C00			; 20 00 7C | Jump to subroutine
	LDA				  ; BF 00 9F 00 | Load from absolute long,X into accumulator
...
;------------------------------------------------------------------------------
WaitForVBlank:
	; Waits for vertical blank period before graphics operations
	; Ensures safe timing for PPU register writes
	ASL				  ; 0A | Arithmetic shift left (accumulator)
...
;------------------------------------------------------------------------------
VBlankDMATransfer:
	; Performs DMA transfer during VBlank interval
	; Critical timing routine for graphics updates
...
;------------------------------------------------------------------------------
; SpriteGraphicsData_0E
; Address: $E0821B
; Size: 16 bytes
; Graphics data for sprite patterns - converted from misidentified code
;------------------------------------------------------------------------------
SpriteGraphicsData_0E:
	db $A0, $80		  ; Graphics pattern data
	db $80, $20		  ; Graphics pattern data
	db $80, $04		  ; Graphics pattern data
	db $11, $00		  ; Graphics pattern data
	db $1A			   ; Graphics pattern data
	db $01, $7D		  ; Graphics pattern data
	db $01, $5F		  ; Graphics pattern data
	db $2A			   ; Graphics pattern data
	db $01, $17		  ; Graphics pattern data

;------------------------------------------------------------------------------
; PaletteGraphicsData_Main
; Address: $E08247
; Size: 27 bytes
; Palette color data for main game graphics
;------------------------------------------------------------------------------
PaletteGraphicsData_Main:
	db $01, $1E		  ; Color data
	db $1D, $2C, $3E	 ; Color data
	db $68			   ; Color data
	db $1A			   ; Color data
	db $09, $17		  ; Color data
	db $06, $01		  ; Color data
	...
	db $66, $1E		  ; Color data
	db $45, $35		  ; Color data
	db $2E, $28, $17	 ; Color data
	db $08			   ; Color data
	db $2D, $0C, $31	 ; Color data
	db $2E, $00, $1F	 ; Color data

;------------------------------------------------------------------------------
; SpriteDataTransfer
; Address: $E08279
; Size: 40 bytes
; Transfers sprite data to VRAM during VBlank period
;------------------------------------------------------------------------------
SpriteDataTransfer:
...
;------------------------------------------------------------------------------
InitializePPU:
	; Initializes PPU registers for graphics display
	; Sets up screen mode, sprite settings, and background layers
...
;------------------------------------------------------------------------------
; GraphicsPatternData_013
; Address: $E082B6
; Size: 14 bytes
; Graphics pattern data for tile/sprite patterns
;------------------------------------------------------------------------------
GraphicsPatternData_013:
	db $80, $40		  ; Pattern data
	db $80, $64		  ; Pattern data
	db $80, $D0		  ; Pattern data
	db $F8			   ; Pattern data
	db $64, $9C		  ; Pattern data
	db $30, $C8		  ; Pattern data
	db $F0, $08		  ; Pattern data
	db $28			   ; Pattern data

;------------------------------------------------------------------------------
; GraphicsPatternData_014
; Address: $E082C7
; Size: 18 bytes
; Graphics pattern data for sprite/tile definitions
;------------------------------------------------------------------------------
GraphicsPatternData_014:
	db $F8			   ; Pattern data
	db $30, $80		  ; Pattern data
	db $E0, $20		  ; Pattern data
	db $E0, $60		  ; Pattern data
	db $F8			   ; Pattern data
	db $C4, $08		  ; Pattern data
	db $08			   ; Pattern data
	db $F8			   ; Pattern data
	db $48			   ; Pattern data
	db $30, $30		  ; Pattern data
	db $30, $10		  ; Pattern data
	db $60			   ; Pattern data

;------------------------------------------------------------------------------
; GraphicsPatternData_015
; Address: $E082DE
; Size: 20 bytes
; Graphics pattern data with WDM marker indicating data block
;------------------------------------------------------------------------------
GraphicsPatternData_015:
	db $30, $00		  ; Pattern data
	db $01, $8E		  ; Pattern data
	db $01, $7F		  ; Pattern data
	db $05, $9F		  ; Pattern data
	db $89, $C9		  ; Pattern data
	db $4D, $18, $5E	 ; Pattern data
	db $42, $41		  ; WDM instruction marker - indicates data
	db $01, $00		  ; Pattern data
	db $88			   ; Pattern data
	db $50, $EF		  ; Pattern data

;------------------------------------------------------------------------------
; GraphicsPatternData_016
; Address: $E082FA
; Size: 24 bytes
; Complex graphics pattern data with JSR/JMP patterns indicating mixed code/data
;------------------------------------------------------------------------------
GraphicsPatternData_016:
	JSR $085F			; 20 5F 08 | Jump to subroutine
	JMP $D9DDE1		  ; 5C E1 DD D9 | Jump to address long
	db $C6, $8B		  ; Graphics data
	db $C6, $CE		  ; Graphics data
	db $09, $49		  ; Graphics data
	db $51, $E7		  ; Graphics data
	db $78			   ; Graphics data
	db $68			   ; Graphics data
	db $C2, $E0		  ; Graphics data
	db $90, $E0		  ; Graphics data
	db $D1, $E0		  ; Graphics data
	RTS				  ; 60 | Return from subroutine

;------------------------------------------------------------------------------
; GraphicsPatternData_018
; Address: $E0831A
; Size: 16 bytes
; Graphics pattern data for sprite/background patterns
;------------------------------------------------------------------------------
GraphicsPatternData_018:
	db $38			   ; Pattern data
	db $80, $8F		  ; Pattern data
	db $40			   ; Pattern data
	db $9F, $00, $13, $1C ; Pattern data sequence
	db $3E, $23, $3E	 ; Pattern data
	db $39, $7C, $33	 ; Pattern data
	db $21, $00		  ; Pattern data

;------------------------------------------------------------------------------
; VBlankGraphicsTransfer
; Address: $E08332
; Size: 17 bytes
; Handles graphics transfer during VBlank period
;------------------------------------------------------------------------------
VBlankGraphicsTransfer:
...
;------------------------------------------------------------------------------
; GraphicsPatternData_01A
; Address: $E0834D
; Size: 15 bytes
; Graphics pattern data for tile patterns
;------------------------------------------------------------------------------
GraphicsPatternData_01A:
	db $90, $90		  ; Pattern data
	db $10, $00		  ; Pattern data
	db $6E, $02, $7E	 ; Pattern data
	db $EE, $08, $F4	 ; Pattern data
	db $28			   ; Pattern data
	db $90, $68		  ; Pattern data
	db $10, $60		  ; Pattern data

;------------------------------------------------------------------------------
; VramAddressSetup
; Address: $E08361
; Size: 37 bytes
; Sets up VRAM addressing for graphics transfers
;------------------------------------------------------------------------------
VramAddressSetup:
...
; Address: $E0838D
; Size: 13 bytes
; Waits for VBlank period before graphics operations
;------------------------------------------------------------------------------
VBlankWaitHandler:
...
; Address: $E0839C
; Size: 37 bytes
; Sets up DMA channel for graphics transfers with proper cleanup
;------------------------------------------------------------------------------
DmaChannelSetup:
...
; Address: $E083D1
; Size: 5 bytes
; Sets graphics display mode configuration
;------------------------------------------------------------------------------
GraphicsDisplayMode:
...
;------------------------------------------------------------------------------
; GraphicsPatternData_021
; Address: $E083D8
; Size: 19 bytes
; Graphics pattern data for sprites/backgrounds
;------------------------------------------------------------------------------
GraphicsPatternData_021:
	db $3A			   ; Pattern data
	db $80, $88		  ; Pattern data
	db $40			   ; Pattern data
	db $9F, $00, $7F, $00 ; Pattern data sequence
	db $09, $3E		  ; Pattern data
	db $4E, $39, $6E	 ; Pattern data
	db $31, $12		  ; Pattern data
	db $1E, $3F, $00	 ; Pattern data
	db $40			   ; Pattern data

;------------------------------------------------------------------------------
; CompoundGraphicsTransfer
; Address: $E083F2
; Size: 78 bytes
; Complex graphics transfer function with embedded data patterns
;------------------------------------------------------------------------------
CompoundGraphicsTransfer:
...
;------------------------------------------------------------------------------
; ComplexGraphicsData_025
; Address: $E0845F
; Size: 93 bytes
; Large graphics data block with mixed patterns
;------------------------------------------------------------------------------
ComplexGraphicsData_025:
	db $C1, $66		  ; Graphics data
	db $6D, $2B, $65	 ; Graphics data
	db $BF, $4B, $F6, $48 ; Graphics data
	db $CC, $41, $07	 ; Graphics data
	db $88			   ; Graphics data
	db $3E, $F1, $19	 ; Graphics data
	db $E0, $30		  ; Graphics data
	db $E0, $70		  ; Graphics data
	db $E0, $00		  ; Graphics data
	db $E0, $01		  ; Graphics data
	db $E0, $23		  ; Graphics data
	db $40			   ; Graphics data
	db $E0, $EF		  ; Graphics data
	db $10, $2E		  ; Graphics data
	db $30, $26		  ; Graphics data
	db $3D, $13, $17	 ; Graphics data
	db $01, $03		  ; Graphics data
	db $01, $1F		  ; Graphics data
	db $E0, $10		  ; Graphics data
	db $21, $10		  ; Graphics data
	db $18			   ; Graphics data
	db $01, $01		  ; Graphics data
	db $01, $A0		  ; Graphics data
	db $80, $D8		  ; Graphics data
	db $F4, $80, $C4	 ; Graphics data
	db $CC, $08, $FE	 ; Graphics data
	db $30, $FA		  ; Graphics data
	db $C4, $FA		  ; Graphics data
	db $40			   ; Graphics data
	db $80, $20		  ; Graphics data
	db $C0, $80		  ; Graphics data
	db $E8			   ; Graphics data
	db $F8			   ; Graphics data
	db $08			   ; Graphics data
	db $F8			   ; Graphics data
	db $30, $34		  ; Graphics data
	db $C4, $00		  ; Graphics data
	db $CE, $48, $B4	 ; Graphics data
	db $80, $FC		  ; Graphics data
	db $F0, $78		  ; Graphics data
	db $40			   ; Graphics data
	db $10, $00		  ; Graphics data
	db $D8			   ; Graphics data
	db $28			   ; Graphics data
	db $84, $EC		  ; Graphics data
	db $30, $48		  ; Graphics data
	db $48			   ; Graphics data
	db $80, $00		  ; Graphics data

;------------------------------------------------------------------------------
; GraphicsPatternData_026
; Address: $E084D8
; Size: 25 bytes
; Graphics pattern data for character/sprite rendering
;------------------------------------------------------------------------------
GraphicsPatternData_026:
	db $E0, $00		  ; Pattern data
	db $F8			   ; Pattern data
	db $9C, $00, $8E	 ; Pattern data
	db $3A			   ; Pattern data
	db $38			   ; Pattern data
	db $1A			   ; Pattern data
	db $78			   ; Pattern data
	db $64, $E4		  ; Pattern data
	db $10, $08		  ; Pattern data
	db $88			   ; Pattern data
	db $B0, $BC		  ; Pattern data
	db $E0, $C0		  ; Pattern data
	db $C4, $00		  ; Pattern data
	db $80, $1E		  ; Pattern data
	db $40			   ; Pattern data
	db $58			   ; Pattern data

;------------------------------------------------------------------------------
; AudioDMAChannelSetup
; Address: $E084FC
; Size: 21 bytes
; Configures DMA channels for audio data transfer
;------------------------------------------------------------------------------
AudioDMAChannelSetup:
...
; Address: $E0851E
; Size: 13 bytes
; Transfers data to VRAM with timing control
;------------------------------------------------------------------------------
VramDataTransfer:
...
;------------------------------------------------------------------------------
; GraphicsPatternData_02A
; Address: $E08532
; Size: 5 bytes
; Simple graphics pattern data
;------------------------------------------------------------------------------
GraphicsPatternData_02A:
	db $10, $60		  ; Pattern data
	db $10, $60		  ; Pattern data
...
;------------------------------------------------------------------------------
; CharacterGraphicsSetup
; Address: $E08546
; Size: 8 bytes
; Sets up character graphics data transfer
;------------------------------------------------------------------------------
CharacterGraphicsSetup:
...
;------------------------------------------------------------------------------
; SpriteAttributeSetup
; Address: $E08552
; Size: 8 bytes
; Sets up sprite attribute data for transfer
;------------------------------------------------------------------------------
SpriteAttributeSetup:
...
;------------------------------------------------------------------------------
; LargeGraphicsData_02F
; Address: $E0855D
; Size: 62 bytes
; Large graphics data block for sprite/tile patterns
;------------------------------------------------------------------------------
LargeGraphicsData_02F:
	db $06, $0C		  ; Graphics data
	db $CE, $48, $B4	 ; Graphics data
	db $80, $FC		  ; Graphics data
	db $F0, $78		  ; Graphics data
	db $40			   ; Graphics data
	db $10, $10		  ; Graphics data
	db $D8			   ; Graphics data
	db $28			   ; Graphics data
	db $9A			   ; Graphics data
	db $FE, $30, $48	 ; Graphics data
	db $48			   ; Graphics data
	db $80, $00		  ; Graphics data
	db $F0, $00		  ; Graphics data
	db $F8			   ; Graphics data
	db $8E, $00, $76	 ; Graphics data
	db $F4, $4C, $44	 ; Graphics data
	db $28			   ; Graphics data
	db $88			   ; Graphics data
	db $98			   ; Graphics data
	db $F8			   ; Graphics data
	db $08			   ; Graphics data
	db $30, $8C		  ; Graphics data
	db $BE, $02, $F8	 ; Graphics data
	db $C4, $00		  ; Graphics data
	db $18			   ; Graphics data
	db $48			   ; Graphics data
...
; Address: $E085C2
; Size: 19 bytes
; Handles PPU control register transfers during graphics operations
;------------------------------------------------------------------------------
PPUControlTransfer:
...
; Address: $E085E0
; Size: 5 bytes
; Initializes PPU registers for graphics mode
;------------------------------------------------------------------------------
PPURegistersInit:
...
; Address: $E085E9
; Size: 11 bytes
; Updates sprite data during VBlank period
;------------------------------------------------------------------------------
VBlankSpriteUpdate:
...
; Address: $E085FA
; Size: 15 bytes
; Handles VRAM bank switching for graphics operations
;------------------------------------------------------------------------------
VRAMBankSwitcher:
...
; Address: $E0860B
; Size: 5 bytes
; Jump vector for interrupt handling in graphics system
;------------------------------------------------------------------------------
InterruptVectorJump:
...
; Address: $E08610
; Size: 5 bytes
; Controls timing for VBlank operations
;------------------------------------------------------------------------------
VBlankTimingControl:
...
;------------------------------------------------------------------------------
; ComplexGraphicsData_036
; Address: $E0861D
; Size: 49 bytes
; Complex graphics pattern data for detailed sprite/tile patterns
;------------------------------------------------------------------------------
ComplexGraphicsData_036:
	db $C0, $F4		  ; Graphics data
	db $E0, $00		  ; Graphics data
	db $1D, $00, $1F	 ; Graphics data
	db $08			   ; Graphics data
	db $08			   ; Graphics data
	db $06, $3F		  ; Graphics data
	db $01, $7F		  ; Graphics data
	db $21, $7F		  ; Graphics data
	db $18			   ; Graphics data
	db $18			   ; Graphics data
	db $0A			   ; Graphics data
	db $01, $05		  ; Graphics data
	db $21, $2B		  ; Graphics data
	db $1E, $00, $0F	 ; Graphics data
	db $10, $02		  ; Graphics data
	db $08			   ; Graphics data
	db $2C, $10, $74	 ; Graphics data
	db $4E, $2E, $29	 ; Graphics data
	db $09, $20		  ; Graphics data
	db $01, $06		  ; Graphics data
	db $50, $00		  ; Graphics data
	db $E8			   ; Graphics data
	db $E8			   ; Graphics data
	db $80, $F8		  ; Graphics data
	db $40			   ; Graphics data
	db $80, $C0		  ; Graphics data
	db $40			   ; Graphics data
	db $60			   ; Graphics data

;------------------------------------------------------------------------------
; GraphicsPatternData_037
; Address: $E086A3
; Size: 6 bytes
; Small graphics pattern data block
;------------------------------------------------------------------------------
GraphicsPatternData_037:
	db $90, $FC		  ; Pattern data
	db $88			   ; Pattern data
	db $EC, $18, $18	 ; Pattern data

;------------------------------------------------------------------------------
; GraphicsPatternData_038
; Address: $E086A9
; Size: 4 bytes
; Compact graphics pattern data
;------------------------------------------------------------------------------
GraphicsPatternData_038:
	db $70, $F8		  ; Pattern data
	db $88			   ; Pattern data
	db $E8			   ; Pattern data

;------------------------------------------------------------------------------
; ComplexSpriteHandler
; Address: $E086AD
; Size: 87 bytes
; Complex sprite handling function with embedded graphics data
;------------------------------------------------------------------------------
ComplexSpriteHandler:
	JSR $C654			; 20 54 C6 | Jump to subroutine - sprite processing
...
;------------------------------------------------------------------------------
; GraphicsPatternData_03A
; Address: $E08729
; Size: 4 bytes
; Simple graphics pattern
;------------------------------------------------------------------------------
GraphicsPatternData_03A:
	db $70, $F8		  ; Pattern data
	db $88			   ; Pattern data
...
;------------------------------------------------------------------------------
; ExtendedSpriteHandler
; Address: $E0872D
; Size: 91 bytes
; Extended sprite handling system with embedded graphics patterns
;------------------------------------------------------------------------------
ExtendedSpriteHandler:
	JSR $C050			; 20 50 C0 | Jump to subroutine - sprite processing
	BVC $90			  ; 50 90 | Branch if overflow clear
	CLV				  ; B8 | Clear overflow flag
	DEY				  ; 88 | Decrement Y register
	CLD				  ; D8 | Clear decimal mode flag
...
;------------------------------------------------------------------------------
; GraphicsPatternData_03C
; Address: $E087C8
; Size: 37 bytes
; Large graphics pattern data block for complex sprites
;------------------------------------------------------------------------------
GraphicsPatternData_03C:
	db $E0, $00		  ; Pattern data
	db $70, $10		  ; Pattern data
	db $F8			   ; Pattern data
	db $38			   ; Pattern data
	db $F8			   ; Pattern data
	db $98			   ; Pattern data
	db $10, $20		  ; Pattern data
	db $38			   ; Pattern data
	db $28			   ; Pattern data
	db $98			   ; Pattern data
	db $D0, $E8		  ; Pattern data
	db $88			   ; Pattern data
	db $88			   ; Pattern data
	db $58			   ; Pattern data
	db $98			   ; Pattern data
	db $A8			   ; Pattern data
	db $B8			   ; Pattern data
	db $B0, $D0		  ; Pattern data
	db $08			   ; Pattern data
	db $D0, $10		  ; Pattern data
	db $E0, $00		  ; Pattern data
	db $88			   ; Pattern data
	db $F0, $18		  ; Pattern data
	db $E0, $18		  ; Pattern data
	db $E0, $48		  ; Pattern data
	db $90, $08		  ; Pattern data

;------------------------------------------------------------------------------
; VramTimingTest
; Address: $E087FA
; Size: 6 bytes
; Tests VRAM timing for graphics operations
;------------------------------------------------------------------------------
VramTimingTest:
...
;------------------------------------------------------------------------------
; GraphicsPatternData_03E
; Address: $E08801
; Size: 10 bytes
; Graphics pattern data for sprite animations
;------------------------------------------------------------------------------
GraphicsPatternData_03E:
	db $40			   ; Pattern data
	db $F0, $80		  ; Pattern data
	db $38			   ; Pattern data
	db $48			   ; Pattern data
	db $B0, $F8		  ; Pattern data
	db $10, $E8		  ; Pattern data
	db $60			   ; Pattern data

;------------------------------------------------------------------------------
; GraphicsPatternData_03F
; Address: $E0880C
; Size: 7 bytes
; Compact graphics pattern data
;------------------------------------------------------------------------------
GraphicsPatternData_03F:
	db $F0, $B0		  ; Pattern data
	db $10, $D0		  ; Pattern data
	db $C0, $C0		  ; Pattern data
	db $60			   ; Pattern data
...
; Address: $E08816
; Size: 19 bytes
; Updates palette data during VBlank period
;------------------------------------------------------------------------------
VBlankPaletteUpdate:
...
;------------------------------------------------------------------------------
; ComplexGraphicsData_042
; Address: $E08843
; Size: 43 bytes
; Complex graphics data with detailed sprite patterns
;------------------------------------------------------------------------------
ComplexGraphicsData_042:
	db $09, $70		  ; Graphics data
	db $01, $10		  ; Graphics data
	db $18			   ; Graphics data
	db $1D, $10, $03	 ; Graphics data
	db $09, $2E		  ; Graphics data
	db $01, $0E		  ; Graphics data
	db $05, $08		  ; Graphics data
	db $18			   ; Graphics data
	db $08			   ; Graphics data
	db $F0, $7C		  ; Graphics data
	db $6C, $46, $47	 ; Graphics data
	db $59, $19, $77	 ; Graphics data
	db $26, $19		  ; Graphics data
	db $0E, $0F, $3F	 ; Graphics data
	db $9F, $00, $9E, $29 ; Graphics data
	db $39, $2F, $2E	 ; Graphics data
	db $0E, $00, $00	 ; Graphics data
	db $CC, $00, $B8	 ; Graphics data
	db $FA			   ; Graphics data
...
; Address: $E0888F
; Size: 6 bytes
; Simple memory test function for graphics system
;------------------------------------------------------------------------------
SimpleMemoryTest:
	JSR $0000			; 20 00 00 | Jump to subroutine
	BMI $20			  ; 30 20 | Branch if negative
...
;------------------------------------------------------------------------------
; SpriteProcessingTest
; Address: $E088A1
; Size: 15 bytes
; Tests sprite processing capabilities
;------------------------------------------------------------------------------
SpriteProcessingTest:
...
;------------------------------------------------------------------------------
; BackgroundLayerSetup
; Address: $E088B0
; Size: 35 bytes
; Sets up background layers for graphics display
;------------------------------------------------------------------------------
BackgroundLayerSetup:
	JSR $84E0			; 20 E0 84 | Jump to subroutine
...
;------------------------------------------------------------------------------
; GraphicsPatternData_046
; Address: $E088DA
; Size: 13 bytes
; Graphics pattern data for tile/character patterns
;------------------------------------------------------------------------------
GraphicsPatternData_046:
	db $9C, $F4, $74	 ; Pattern data
	db $70, $00		  ; Pattern data
	db $70, $0B		  ; Pattern data
	db $10, $00		  ; Pattern data
	db $06, $00		  ; Pattern data
	db $11, $00		  ; Pattern data

;------------------------------------------------------------------------------
; VramDataHandler
; Address: $E088FC
; Size: 15 bytes
; Handles VRAM data transfer operations
;------------------------------------------------------------------------------
VramDataHandler:
...
;------------------------------------------------------------------------------
; VBlankGraphicsHandler
; Address: $E08916
; Size: 20 bytes
; Handles graphics operations during VBlank period
;------------------------------------------------------------------------------
VBlankGraphicsHandler:
	JSR $7C00			; 20 00 7C | Jump to subroutine
	LDA				  ; BF 00 9F 00 | Load from absolute long,X into accumulator
...
;------------------------------------------------------------------------------
; ComplexSpriteData_049
; Address: $E08935
; Size: 38 bytes
; Complex sprite data with embedded graphics patterns
;------------------------------------------------------------------------------
ComplexSpriteData_049:
	JSR $6000			; 20 00 60 | Jump to subroutine - sprite processing
	db $88			   ; Graphics data
	db $26, $00		  ; Graphics data
	db $DA			   ; Graphics data
	db $3E, $E4, $F6	 ; Graphics data
	db $FD, $17, $DF	 ; Graphics data
	db $C2, $32		  ; Graphics data
	db $0A			   ; Graphics data
	db $CE, $EA, $1F	 ; Graphics data
	db $05, $07		  ; Graphics data
	db $38			   ; Graphics data
	db $06, $FD		  ; Graphics data
	db $F0, $01		  ; Graphics data
	db $F0, $00		  ; Graphics data
	db $28			   ; Graphics data
	JMP $732C60		  ; 5C 60 2C 73 | Jump to address long
	db $70, $00		  ; Graphics data
	db $10, $07		  ; Graphics data
	db $08			   ; Graphics data

;------------------------------------------------------------------------------
; GraphicsDataBlock_04A
; Address: $E08976
; Size: 18 bytes
; Graphics data block for sprite patterns
;------------------------------------------------------------------------------
GraphicsDataBlock_04A:
	JSR $7C00			; 20 00 7C | Jump to subroutine - graphics processing
	db $BF, $00, $9F, $00 ; Graphics data
	db $9F, $00, $D0, $00 ; Graphics data
	db $F0, $00		  ; Graphics data
	db $F8			   ; Graphics data
	db $F8			   ; Graphics data
	db $06, $FB		  ; Graphics data
	db $FA			   ; Graphics data

;------------------------------------------------------------------------------
; LargeSpriteDataBlock_04C
; Address: $E08995
; Size: 86 bytes
; Large sprite/graphics data block with complex patterns
;------------------------------------------------------------------------------
LargeSpriteDataBlock_04C:
	JSR $6000			; 20 00 60 | Jump to subroutine - graphics processing
	db $8E, $00, $27	 ; Graphics data
	db $DE, $34, $36	 ; Graphics data
	db $E4, $F5		  ; Graphics data
	db $DE, $C2, $30	 ; Graphics data
	db $0A			   ; Graphics data
	db $70, $87		  ; Graphics data
	db $EA			   ; Graphics data
	db $1E, $04, $37	 ; Graphics data
	db $05, $47		  ; Graphics data
	db $06, $3D		  ; Graphics data
	db $01, $F8		  ; Graphics data
	db $F1, $00		  ; Graphics data
	db $7D, $06, $7F	 ; Graphics data
	db $01, $00		  ; Graphics data
	db $30, $00		  ; Graphics data
	db $05, $2F		  ; Graphics data
	db $25, $3B		  ; Graphics data
	db $18			   ; Graphics data
	db $1A			   ; Graphics data
	db $18			   ; Graphics data
	db $3A			   ; Graphics data
	db $78			   ; Graphics data
	JMP $150F15		  ; 5C 15 0F 15 | Jump to address long - graphics function
	db $01, $06		  ; Graphics data
	db $05, $02		  ; Graphics data
	db $18			   ; Graphics data
	db $28			   ; Graphics data
	db $01, $61		  ; Graphics data
	db $40			   ; Graphics data
	db $F0, $00		  ; Graphics data
	db $F8			   ; Graphics data
	db $F8			   ; Graphics data
	...
	db $78			   ; Graphics data
	db $18			   ; Graphics data
	db $10, $18		  ; Graphics data
	db $40			   ; Graphics data
	db $30, $04		  ; Graphics data
	db $06, $1C		  ; Graphics data
	db $06, $FC		  ; Graphics data
	db $C0, $24		  ; Graphics data
	db $C0, $B0		  ; Graphics data
	db $A0, $98		  ; Graphics data
	db $A8			   ; Graphics data
	db $10, $38		  ; Graphics data
	db $28			   ; Graphics data

;------------------------------------------------------------------------------
; ExtendedGraphicsData_04D
; Address: $E08A28
; Size: 79 bytes
; Extended graphics data block with complex sprite patterns
;------------------------------------------------------------------------------
ExtendedGraphicsData_04D:
	db $F4, $08, $18	 ; Graphics data
	db $50, $F4		  ; Graphics data
	db $8C, $C0, $84	 ; Graphics data
	db $C0, $04		  ; Graphics data
	db $C0, $00		  ; Graphics data
	db $C0, $00		  ; Graphics data
	db $80, $E0		  ; Graphics data
	db $FA			   ; Graphics data
	db $3E, $03, $7F	 ; Graphics data
	db $01, $7D		  ; Graphics data
	db $01, $7F		  ; Graphics data
	db $01, $00		  ; Graphics data
	db $01, $07		  ; Graphics data
	db $0A			   ; Graphics data
	db $2D, $21, $3C	 ; Graphics data
	db $09, $19		  ; Graphics data
	db $01, $1E		  ; Graphics data
	db $1D, $2C, $3E	 ; Graphics data
	db $68			   ; Graphics data
	db $11, $27		  ; Graphics data
	db $06, $01		  ; Graphics data
	db $01, $70		  ; Graphics data
	db $40			   ; Graphics data
	db $F0, $00		  ; Graphics data
	db $F8			   ; Graphics data
	db $F8			   ; Graphics data
	db $18			   ; Graphics data
	db $B0, $1C		  ; Graphics data
	db $98			   ; Graphics data
	db $88			   ; Graphics data
	db $D0, $C8		  ; Graphics data
	db $40			   ; Graphics data
	db $30, $04		  ; Graphics data
	db $06, $DC		  ; Graphics data
	db $06, $FC		  ; Graphics data
	db $84, $F0		  ; Graphics data
	db $C4, $F0		  ; Graphics data
	db $D0, $C0		  ; Graphics data
	db $98			   ; Graphics data
	db $88			   ; Graphics data
	db $30, $18		  ; Graphics data
	db $28			   ; Graphics data
	db $F4, $08, $98	 ; Graphics data

;------------------------------------------------------------------------------
; PPUControlSetup
; Address: $E08AAC
; Size: 10 bytes
; Sets up PPU control registers for graphics operations
;------------------------------------------------------------------------------
PPUControlSetup:
	JSR $7870			; 20 70 78 | Jump to subroutine
	PHP				  ; 08 | Push processor status to stack
...
;------------------------------------------------------------------------------
; VeryLargeGraphicsData_050
; Address: $E08ABB
; Size: 100 bytes
; Very large graphics data block with extensive sprite/tile patterns
;------------------------------------------------------------------------------
VeryLargeGraphicsData_050:
	db $80, $D0		  ; Graphics data
	db $F8			   ; Graphics data
	db $01, $00		  ; Graphics data
	db $3E, $01, $39	 ; Graphics data
	db $06, $3C		  ; Graphics data
	db $49, $4F		  ; Graphics data
	db $01, $02		  ; Graphics data
	db $06, $00		  ; Graphics data
	db $01, $07		  ; Graphics data
	db $10, $E0		  ; Graphics data
	db $4C, $E0, $40	 ; Graphics data
	db $68			   ; Graphics data
	db $F8			   ; Graphics data
	db $F8			   ; Graphics data
	db $38			   ; Graphics data
	db $C0, $78		  ; Graphics data
	db $E0, $20		  ; Graphics data
	db $E0, $90		  ; Graphics data
	db $90, $00		  ; Graphics data
	db $68			   ; Graphics data
	db $D0, $00		  ; Graphics data
	db $C0, $80		  ; Graphics data
	db $E0, $18		  ; Graphics data
	db $68			   ; Graphics data
	db $70, $30		  ; Graphics data
	db $C0, $A0		  ; Graphics data
	db $CC, $E4, $22	 ; Graphics data
	db $2E, $58, $14	 ; Graphics data
	db $FA			   ; Graphics data
	db $FE, $E6, $F6	 ; Graphics data
	db $0E, $88, $00	 ; Graphics data
	db $10, $00		  ; Graphics data
	db $DE, $00, $BE	 ; Graphics data
	db $1D, $00, $B9	 ; Graphics data
	db $F9, $00, $01	 ; Graphics data
	db $3E, $01, $39	 ; Graphics data
	db $46, $5C		  ; Graphics data
	db $49, $4F		  ; Graphics data
	db $01, $02		  ; Graphics data
	db $06, $00		  ; Graphics data
	db $01, $47		  ; Graphics data
	db $50, $E0		  ; Graphics data
	db $CC, $E0, $DD	 ; Graphics data
	db $99, $C6, $CB	 ; Graphics data
	db $06, $4E		  ; Graphics data
	db $69, $49		  ; Graphics data
	db $E5, $71		  ; Graphics data
	db $38			   ; Graphics data
	db $6B			   ; RTL - Return from subroutine long

;------------------------------------------------------------------------------
; GraphicsDisplayMode_052
; Address: $E08B51
; Size: 5 bytes
; Sets graphics display mode parameters
;------------------------------------------------------------------------------
GraphicsDisplayMode_052:
	CPX #$D0			 ; E0 D0 | Compare X register (immediate)
	CPX #$91			 ; E0 91 | Compare X register (immediate)
...
;------------------------------------------------------------------------------
; MassiveGraphicsData_054
; Address: $E08B58
; Size: 84 bytes
; Massive graphics data block for complex sprite animations
;------------------------------------------------------------------------------
MassiveGraphicsData_054:
	db $3A			   ; Graphics data
	db $80, $88		  ; Graphics data
	db $40			   ; Graphics data
	db $9F, $00, $7F, $00 ; Graphics data
	db $70, $30		  ; Graphics data
	db $C0, $A0		  ; Graphics data
	db $C8			   ; Graphics data
	db $E8			   ; Graphics data
	db $24, $2C		  ; Graphics data
	db $58			   ; Graphics data
	db $30, $FE		  ; Graphics data
	db $E6, $E6		  ; Graphics data
	db $1E, $88, $00	 ; Graphics data
	db $10, $00		  ; Graphics data
	db $18			   ; Graphics data
	db $BE, $00, $1E	 ; Graphics data
	db $B9, $00, $F9	 ; Graphics data
	db $10, $1F		  ; Graphics data
	db $08			   ; Graphics data
	db $01, $1E		  ; Graphics data
	db $AA			   ; Graphics data
	db $66, $4E		  ; Graphics data
	db $10, $10		  ; Graphics data
	db $30, $18		  ; Graphics data
	db $30, $1E		  ; Graphics data
	db $51, $E0		  ; Graphics data
	db $6D, $2B, $65	 ; Graphics data
	db $BF, $4B, $F6, $48 ; Graphics data
	db $CC, $41, $07	 ; Graphics data
	db $88			   ; Graphics data
	db $3E, $F1, $18	 ; Graphics data
	db $E0, $30		  ; Graphics data
	db $E0, $70		  ; Graphics data
	db $E0, $00		  ; Graphics data
	db $E0, $01		  ; Graphics data
	...
	db $C8			   ; Graphics data
	db $F0, $00		  ; Graphics data
	db $FE, $00, $FE	 ; Graphics data
	db $80, $7E		  ; Graphics data
	db $60			   ; Graphics data

;------------------------------------------------------------------------------
; GraphicsPatternData_055
; Address: $E08BD5
; Size: 6 bytes
; Simple graphics pattern data
;------------------------------------------------------------------------------
GraphicsPatternData_055:
	db $80, $00		  ; Pattern data
	BRA $00			  ; 80 00 | Branch always
